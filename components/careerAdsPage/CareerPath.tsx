        ...
        <div className='flex justify-start flex-col items-center gap-8 h-full'>
            <div className='flex flex-col sm:flex-row w-full max-w-4xl sm:p-4 bg-white'>
                ...
                <div className='flex flex-col'>
                    <div className='border rounded-lg flex-1 flex flex-col items-center justify-center p-2'>
                        <input
                            type="text"
                        ...
                        <button
                            type="submit"
                            className="bg-blue-500 text-slate-50 w-full py-1.5 px-4 rounded-2xl"
                        >UNLOCK THIS</button>
